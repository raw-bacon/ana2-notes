...
Vergleiche~\cite{heuser}, Abschnitt 119.

\subsection*{Vorbereitungen zum Beweis}
\begin{definition}
...
\begin{enumerate}[(i)]
  ...
  \item Sei umgekehrt $\gamma \in C([-T, T], \mathbb{R}^n)$
    ...
    $\dot \gamma(t) = X(\gamma(t))$.
\end{enumerate}
Das Theorem reduziert sich also auf ein Fixpunktproblem,
welches wir hoffentlich mit Banachs Fixpunktsatz lösen können.
