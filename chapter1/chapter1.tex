...
\begin{proof}
  ...
  welche in allen Koordinaten konvergiert. % 'w' muss noch definiert werden.
  ...
  \begin{align*}
     ...
     &\leq \Vert w \Vert_2 \\ % diesen Schritt verstehe ich nicht, aber ich frag's dich dann Mittwoch
...
\begin{specialcase}
  ...
  \[
    ...
    \end{pmatrix}
  \]
  als Matrix, das heisst $A(e_i) = \sum_{j=1}^{m} a_{ij}e_j$. % oder? Du muss die Einträge der j. Spalte addieren.
