...
\begin{examples}
  ...
  \begin{enumerate}[(1)]
    ...
    \item Die Differentialgleichung
      ...
      siehe Beispiel (3).
    \item Betrachte allgemeiner
      die Differentialgleichung
      $\ddot y(t) + a \dot y(t) + by(t) = 0$
      für  $a,b \in \mathbb{R}$.
      Setze wieder
      $\gamma(t) = (y(t), \dot y(t))$.
      Dann gilt $\dot \gamma(t) = A \gamma(t)$
      für
      \[
        A =
        \begin{pmatrix}
      ...
      wir nicht explizit
      $e ^{tA}$ ausrechnen müssen,
      um die Differentialgleichung
      $\dot \gamma(t) = A \gamma(t)$ zu lösen.
      Betrachte dazu drei Fälle.
      \begin{enumerate}[(i)]
        \item Falls $A$ diagonalisierbar
          ist mit Eigenwerten
          $\lambda_1, \lambda_2 \in \mathbb{R}$,
          dann sehen wir leicht, dass alle
          Linearkombinationen der Form
          $y(t) = ce^{\lambda_1 t}
          + d e^{\lambda_2 t}$
          Lösungen sind,
          und umgekehrt.
        \item Falls $A$ einen doppelten
          Eigenwert $\lambda \in \mathbb{R}$
          hat,
          aber nicht diagonalisierbar ist,
          ...
          \[
            ...
            \end{pmatrix}.
          \]
          Es ist nun leicht zu sehen,
          dass die Lösungen
          von der Form
          $y(t) = c e^{\lambda t} + d t e^{\lambda t}$
          für $c, d \in \mathbb{R}$ sind.
        \item Falls $A$ zwei komplex
          konjugierte nicht reelle
          Eigenwerte hat,
          dann sind auch die Terme
          $e^{\lambda_1 t}$ und
          $e^{\lambda_2 t}$ nicht reell.
          Schreibe
          $\lambda_1 = u + i v$.
          Dann gilt
          $\lambda_2 = u - iv$.
          ...
          = e^{ut} \cdot e^{ivt}$
          und
          $e^{\lambda_2 t} = e^{ut} \cdot e^{-ivt}$
          um reelle Lösungen zu finden.
      \end{enumerate}
